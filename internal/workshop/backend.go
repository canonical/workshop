...
type BaseImage struct {
	...
	// Type of sandbox used to run the image (e.g. lxd-container).
...
type BaseImageManager interface {
	...
	GetBase(ctx context.Context, base string, runtime Runtime) (BaseImage, error)
...
func BaseOnly(format sdk.Revision, name string, runtime Runtime, fingerprint string) Snapshot {
	return Snapshot{Format: format, Image: BaseImage{Name: name, Runtime: runtime, Fingerprint: fingerprint}}
}

...
.. meta::
   :description: Release notes for Workshop and SDKcraft 0.9.5, covering
                 ...
                 configuration, the --sdks flag for workshop init, Ubuntu One
                 SSO migration in SDKcraft, new sdkcraft login --export and
                 logout commands, vscode-remote SDK deprecation, documentation
                 improvements, and preparation for the first public VS Code
                 Workshop extension release.
```
...
- Added `workshop init --sdks` to allow in-project and try SDKs.
